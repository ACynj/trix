...
sys.path.insert(0, '/T20030104/ynj/TRIX')
...
def generate_markdown_report(results1: Dict[str, Dict[str, float]], 
                             ...
                             name2: str = "run_commands_20251225_041027.log"):
    """生成Markdown格式的对比报告"""
    ...
    report.append(f"**基准文件**: {name1}  \n")
    report.append(f"**对比文件**: {name2}\n")
    report.append("\n---\n")
...
if __name__ == "__main__":
    ...
    log_file2 = "/T20030104/ynj/TRIX/run_commands_20251225_041027.log"
    
    print("正在解析日志文件...")
    results1 = parse_log_file(log_file1)
    results2 = parse_log_file(log_file2)
    
    print(f"基准文件找到 {len(results1)} 个数据集的结果")
    print(f"对比文件找到 {len(results2)} 个数据集的结果")
    
    print("正在生成Markdown报告...")
    report = generate_markdown_report(results1, results2, 
                                      "inference_rel.log (基准)", 
                                      "run_commands_20251225_041027.log")
    
    output_file = "/T20030104/ynj/TRIX/comparison_report_2.md"
